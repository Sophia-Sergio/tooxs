class DataCasesController < ApplicationController
  ...
  private
    ...
    def data_case_params
      params.require(:data_case).permit(:id_case, :turn_num, :dep_num, :day_num, :hour_day, :hp_val, :prod_obj, :vhp, :pov, :lunch_in, :lunch_hours, :hour_min, :turns_matrix, :real_dot, :sale_plan, :sale_plan, :month, :year)
    end
end
