...
RSpec.describe "return_cases/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit return_case form" do
    render

    assert_select "form[action=?][method=?]", return_case_path(@return_case), "post" do
