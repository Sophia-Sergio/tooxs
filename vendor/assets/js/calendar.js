...
(function($) {
    ...
    $(document).ready(function() {
        ...
        if ( $('.available_shift_view_single').length > 0) {
            console.log('busqueda de data de turno')
        ...
        $('#nomyCalendar').pagescalendar({
            ...
            slotDuration: '60', //In Mins : only supports 30 and 60
            events: (events),
            eventOverlap: true,
            weekends:true,
            disableDates:[],
